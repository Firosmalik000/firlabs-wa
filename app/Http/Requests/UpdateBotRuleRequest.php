...
class UpdateBotRuleRequest extends FormRequest
{
    /**
    ...
    {
        /** @var BotRule|null $botRule */
        $botRule = $this->route('botRule');

        return $this->user() !== null
            && $botRule !== null
            && $this->user()->can('update', $botRule);
    }
    ...
    public function rules(): array
    {
        /** @var BotRule|null $botRule */
        $botRule = $this->route('botRule');
        $tenant = $botRule?->tenant ?? $this->user()?->currentTenant;
